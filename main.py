...
def connect_to_database():
    ...
    # db_password = os.environ.get("DB_PASSWORD", "rootpswd")
    # db_name = os.environ.get("DB_NAME", "tiktoklivestalker")
    db_host = os.environ.get("DB_HOST", "10.0.0.137")
    db_port = os.environ.get("DB_PORT", "5432")
    db_user = os.environ.get("DB_USER", "tls_suser")
    db_password = os.environ.get("DB_PASSWORD", "z8bg88lp6Ak6")
    db_name = os.environ.get("DB_NAME", "tiktoklivestalker")
    try:
